...
Scott-Hayward, L.A.S., Oedekoven, C.S., Mackenzie, M.L. and Walker, C.G. (2017). Vignette for the MRSea Package v0.99: Statistical Modelling of bird and cetacean distributions in offshore renewables development areas. Centre for Research into Ecological and Environmental Modelling, University of St Andrews.
...
The black points in the figure are the data and the red points, the candidate knot locations. By default, the knotgrid has 300 legal knot positions chosen.
...
```{r }
cv.gamMRSea(data, salsa2dOutput$bestModel, K=10)
