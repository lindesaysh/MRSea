...
#'   
#' \code{fitnessMeasure}. The criterion for selecting the `best' model.  Available options: AIC, AIC_c, AIC_H, BIC, QAIC, QAIC_c, QBIC, QBIC_c, QIC_b.
#' 
...
#' @export
#' 
runSALSA1D_withremoval<-function(initialModel, salsa1dlist, varlist, factorlist=NULL, predictionData, varlist_cyclicSplines=NULL, splineParams=NULL, datain, removal=TRUE){
  ...
  if(salsa1dlist$fitnessMeasure[1]=='QAIC' | salsa1dlist$fitnessMeasure[1]=='QAICc' | salsa1dlist$fitnessMeasure=='QBIC'){
