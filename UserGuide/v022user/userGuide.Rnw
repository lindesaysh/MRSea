...
<<>>=
salsa1dlist <- list(fitnessMeasure = "BIC", minKnots_1d = 2,maxKnots_1d = 5, 
...
Use the built in summary function to look at the summary of the model.  This function differs from {\tt summary} as it shortens the variable names for ease of viewing the output.

<<>>=
summary.m(salsa1dOutput$bestModel,varlist = c("depth"), factorlist=c('as.factor(season)', 'as.factor(impact)'))
@
...
salsa2dlist<-list(fitnessMeasure = 'BIC', knotgrid = knotgrid, 
