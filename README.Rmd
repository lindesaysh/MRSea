...
You can install the development version of inlabru from [GitHub](https://github.com/lindesaysh/MRSea) with:
...
These are available using `browseVignettes(package='MRSea')` if you installed from the `.tar.gz` in the latest release. 