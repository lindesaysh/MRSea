...
5. [Full Case Study](https://lindesaysh.github.io/MRSea/article/RenewablesCaseStudy_MRSea) including information on distance sampling, `gamMRSea` model diagnostics and using robust standard errors to deal with residual correlation. 
