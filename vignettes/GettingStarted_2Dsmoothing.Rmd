...
```{r message=FALSE, warning=FALSE, eval=TRUE, fig=TRUE, fig.align='center', fig.width=6, fig.height=4}
...
```{r knotgrid, fig=TRUE, fig.align='center', fig.width=6, fig.height=4, fig.cap="Plot showing the candidate knot locations in red and the raw data locations in black."}
set.seed(123)
