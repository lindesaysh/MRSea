...
```{r }
(rs.orig <- getRadiiChoices(numberofradii = 10, distMatrix = distMats$dataDist, basis = "gaussian"))
```
...
```{r}
rs <- getRadiiChoices.vario(numberofradii = 10,
...
# CV scores
set.seed(154)
cv.gamMRSea(wfdata, salsa2dOutput.origr, K=10)$delta[2]
set.seed(154)
cv.gamMRSea(wfdata, salsa2dOutput.vario, K=10)$delta[2]
```
