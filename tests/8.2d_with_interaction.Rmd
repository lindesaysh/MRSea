...
cat("Sum of all predictions on response scale:", sum(preds_out), "this should be 17445.02. \n\n")

cat("Sum of all predictions on link scale:", sum(preds_out_link), "this should be -56198.83. \n\n")
...
cat("Sum of all estimates:", sum(sum_results$coefficients[,1]), "this should be 15.35067. \n\n")

cat("Sum of all robust SE:", sum(sum_results$coefficients[,3]), "this should be 44.21518. \n\n")

cat("Dispersion:", sum_results$dispersion, "this should be 8.132169. \n\n")
