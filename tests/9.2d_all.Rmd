...
cat("Sum of all predictions on response scale:", sum(preds_out), "this should be 4379.561. \n\n")

cat("Sum of all predictions on link scale:", sum(preds_out_link), "this should be -13518.88. \n\n")
...
cat("Sum of all estimates:", sum(sum_results$coefficients[,1]), "this should be 19.04515. \n\n")

cat("Sum of all robust SE:", sum(sum_results$coefficients[,3]), "this should be 22.32133. \n\n")
...
cat("Dispersion:", sum_results$dispersion, "this should be 7.626664. \n\n")
...
cat("Mean square error:", mean_sum_sq, "this should be 0.2619761. \n\n")
